                    ...
                    <div class="p-sticky">
                        <div class="category-menu">
                            ...
                            <ul>
                                ...
                                <li>
                                    <div class="category-list">
                                        <img src="{{ asset('frontend_assets') }}/svg/1/cup.svg" class="blur-up lazyload"
                                            alt="">
                                        <h5>
                                ...
                                <li>
                                    <div class="category-list">
                                        <img src="{{ asset('frontend_assets') }}/svg/1/meats.svg" class="blur-up lazyload"
                                            alt="">
                                        <h5>
                                ...
                                <li>
                                    <div class="category-list">
                                        <img src="{{ asset('frontend_assets') }}/svg/1/drink.svg"
                                            class="blur-up lazyload" alt="">
                                        <h5>
                                ...
                                <li>
                                    <div class="category-list">
                                        <img src="{{ asset('frontend_assets') }}/svg/1/milk.svg" class="blur-up lazyload"
                                            alt="">
                                        <h5>
                                ...
                                <li class="pb-30">
                                    <div class="category-list">
                                        <img src="{{ asset('frontend_assets') }}/svg/1/pet.svg" class="blur-up lazyload"
                                            alt="">
                                        <h5>
                ...
                <div class="col-xxl-9 col-xl-8">
                    ...
                    <div class="section-b-space">
                        <div class="product-border border-row overflow-hidden">
                            <div class="row row-cols-1 row-cols-md-3 row-cols-xl-4 row-cols-lg-5  ">
                        ...
                        <div class="category-slider-2 product-wrapper no-arrow">
                            ...
                            <div>
                                <a href="shop-left-sidebar.html" class="category-box category-dark">
                                    <div>
                                        <img src="{{ asset('frontend_assets') }}/svg/1/meats.svg"
                                            class="blur-up lazyload" alt="">
                                        <h5>Meats & Seafood</h5>
                                    </div>
                                </a>
